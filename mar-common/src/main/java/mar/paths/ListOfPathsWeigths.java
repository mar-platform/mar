...
public class ListOfPathsWeigths extends ListofPaths{

	public ListOfPathsWeigths(@NonNull List<? extends Path> paths, @Nonnull PathFactory factory) {
		super(paths, factory);
	}
