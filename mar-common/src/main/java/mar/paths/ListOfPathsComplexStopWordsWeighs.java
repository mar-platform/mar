...
public class ListOfPathsComplexStopWordsWeighs extends ListofPaths{
	
	public ListOfPathsComplexStopWordsWeighs(@NonNull List<? extends Path> lps, @NonNull PathFactory factory) {
		super(lps, factory);
	...
	public PartitionedPathMap toMapParticionedPaths() {
		...
		ListOfPathsWeigths lps = new ListOfPathsWeigths(newpaths, factory);
