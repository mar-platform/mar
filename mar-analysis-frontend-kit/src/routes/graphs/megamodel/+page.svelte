<script lang="ts">
	...
	import { INITIAL_LABEL_THRESHOLD_LARGE } from "$lib/constants/values";
    ...
    async function setGraphMode() {
        ...
        globalState.labelThreshold = INITIAL_LABEL_THRESHOLD_LARGE;
...
<GraphRepresentation mode="MEGAMODEL" />
