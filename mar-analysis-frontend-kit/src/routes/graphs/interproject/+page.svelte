<script lang="ts">
	...
	import { INITIAL_LABEL_SIZE, INITIAL_LABEL_THRESHOLD_MEDIUM, INITIAL_NODE_SIZE } from "$lib/constants/values";
    ...
    async function setGraphMode() {
        ...
        globalState.nodeSize = INITIAL_NODE_SIZE;
        globalState.labelSize = INITIAL_LABEL_SIZE;
        
        globalState.setGraphMode('INTER_PROJECT');
    }

    setGraphMode();
</script>

<GraphRepresentation mode="INTER_PROJECT" />
