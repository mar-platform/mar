    ...
    <div class="list-group-item list-group-item-action flex-column align-items-start">
      <div class="row">
          ...
          <p class="align-items-right item-information-bar">
            {#if item.metadata}
              {#if item.metadata.category}
                <span class="badge badge-light item-category">{item.metadata.category}</span>
              {/if}
        ...
        <div class="col-0">
          ...
          <p><a href="{MAR.toImageURL(item.id, ItemHelper.modelType(item))}"><img src="img/iconfinder_Artboard_37_3952964.png" alt="See diagram" width=24 height=24></a></p>
